const itActsAsFavoriteMovieModel = (favoriteMovie) => {
  ...
  it("should refuse a movie from being added if it does not have a correct property", async () => {
  ...
  it("should handler request to remove a movie even though the movie has not been added", async () => {
    favoriteMovie.putMovie({ id: 1 });
    favoriteMovie.putMovie({ id: 2 });
    favoriteMovie.putMovie({ id: 3 });

    await favoriteMovie.deleteMovie(5);
